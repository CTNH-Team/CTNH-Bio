...
public class BioElectricRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CBRecipeBuilder.of(CTNHBio.id("grass_block"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.STONE_POWDER.get()), UniformInt.of(0, 1))
                .EUt(32)
                .duration(60)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("sand"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.MINERAL_FRAGMENT.get()), UniformInt.of(0, 1))
                .EUt(32)
                .duration(60)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("lily_of_the_valley"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(1, 2))
                .outputFluidsRanged(new FluidStack(Toxin_Extract.getFluid(), 1), UniformInt.of(0, 1))
                .EUt(32)
                .duration(60)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("oxeye_daisy"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(1, 2))
                .outputFluidsRanged(new FluidStack(Regenerate_Fluid.getFluid(), 1), UniformInt.of(0, 1))
                .EUt(32)
                .duration(60)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("wither_rose"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(1, 2))
                .outputItemsRanged(new ItemStack(ModItems.EXOTIC_DUST.get()), UniformInt.of(0, 1))
        ...
        CBRecipeBuilder.of(CTNHBio.id("glowstone"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.BIO_LUMENS.get()), UniformInt.of(0, 4))
                .EUt(32)
                .duration(200)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("lapis_lazuli"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.GEM_FRAGMENTS.get()), UniformInt.of(0, 1))
                .outputItemsRanged(new ItemStack(ModItems.EXOTIC_DUST.get()), UniformInt.of(0, 1))
                .EUt(32)
                .duration(100)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("feather"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.TOUGH_FIBERS.get()), UniformInt.of(0, 1))
                .outputItemsRanged(new ItemStack(ModItems.MINERAL_FRAGMENT.get()), UniformInt.of(0, 1))
                .EUt(32)
                .duration(40)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("magma_cream"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputFluidsRanged(new FluidStack(Mutagenic_Secretion.getFluid(), 1), UniformInt.of(0, 200))
                .EUt(32)
                .duration(240)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("egg"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputFluidsRanged(new FluidStack(Endocrine_Hormone.getFluid(), 1), UniformInt.of(0, 100))
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(0, 2))
                .EUt(32)
                .duration(60)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("rotten_flesh"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.ELASTIC_FIBERS.get()), UniformInt.of(0, 1))
                .EUt(32)
                .duration(80)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("spider_eye"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputFluidsRanged(new FluidStack(Bile.getFluid(), 1), UniformInt.of(0, 100))
        ...
        CBRecipeBuilder.of(CTNHBio.id("pitcher_pod"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputFluidsRanged(new FluidStack(Bile.getFluid(), 1), UniformInt.of(100, 300))
                .outputItemsRanged(new ItemStack(ModItems.EXOTIC_DUST.get()), UniformInt.of(0, 3))
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(2, 4))
                .EUt(32)
                .duration(180)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("pitcher_plant"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.EXOTIC_DUST.get()), UniformInt.of(0, 3))
                .outputFluidsRanged(new FluidStack(Toxin_Extract.getFluid(), 1), UniformInt.of(0, 200))
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(2, 4))
                .EUt(32)
                .duration(180)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("torchflower"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.BIO_LUMENS.get()), UniformInt.of(0, 2))
                .outputItemsRanged(new ItemStack(ModItems.ORGANIC_MATTER.get()), UniformInt.of(1, 2))
                .EUt(32)
                .duration(80)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("living_flesh"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.FLESH_BITS.get()), UniformInt.of(3, 6))
                .outputItemsRanged(new ItemStack(ModItems.EXOTIC_DUST.get()), UniformInt.of(0, 2))
                .EUt(32)
                .duration(180)
                .save(provider);
        ...
        CBRecipeBuilder.of(CTNHBio.id("primal_orifice"), CBRecipeTypes.DECOMPOSER_RECIPES)
                ...
                .outputItemsRanged(new ItemStack(ModItems.FLESH_BITS.get()), UniformInt.of(0, 2))
