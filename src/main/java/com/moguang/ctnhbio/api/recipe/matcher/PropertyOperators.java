...
public class PropertyOperators {
    ...
    public static final PropertyOperator<Number> GREATER = PropertyOperator.create("greater", ">",
            (a, b) -> a.doubleValue() > b.doubleValue());
    public static final PropertyOperator<Number> LESSER = PropertyOperator.create("lesser", "<",
            (a, b) -> a.doubleValue() < b.doubleValue());
