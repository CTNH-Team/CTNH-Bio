...
public class CBTags {
    ...
    public static final TagKey<Block> GROWING_REPLACEABLE_TAG = BlockTags
            .create(ResourceLocation.tryBuild("ctnhbio", "growing_replaceable"));
    ...
    public static final TagKey<Item> RAW_MEATS_TAG = ItemTags
            .create(ResourceLocation.tryBuild("biomancy", "raw_meats"));
    public static final TagKey<Item> COOKED_MEATS_TAG = ItemTags
            .create(ResourceLocation.tryBuild("biomancy", "cooked_meats"));
