...
public class NutrientElement extends Element {
    ...
    public NutrientElement(double nutrientCapacity, double nutrientAmount) {
        this.text = String.format(" %s/%s", DisplayHelper.dfCommas.format(nutrientAmount),
    ...
    public void render(GuiGraphics guiGraphics, float x, float y, float maxX, float maxY) {
        DisplayHelper.INSTANCE.drawText(guiGraphics,
                Component.translatable("jade.nutrient.info").getString() + this.text, x, y,
                IThemeHelper.get().getNormalColor());
    }
}
