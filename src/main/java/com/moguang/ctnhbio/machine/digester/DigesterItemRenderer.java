...
public class DigesterItemRenderer extends GeoItemRenderer<LivingMetaMachineItem> {


    public DigesterItemRenderer() {
        super((GeoModel<LivingMetaMachineItem>)(GeoModel<?>)new DigesterModel());
    }
