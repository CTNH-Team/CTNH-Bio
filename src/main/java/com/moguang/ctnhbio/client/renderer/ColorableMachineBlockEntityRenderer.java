...
public class ColorableMachineBlockEntityRenderer extends GeoBlockRenderer<LivingMetaMachineBlockEntity> {
    ...
    @Override
    public RenderType getRenderType(LivingMetaMachineBlockEntity animatable, ResourceLocation texture,
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, LivingMetaMachineBlockEntity animatable, GeoBone bone,
